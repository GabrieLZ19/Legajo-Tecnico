    ...
    if (informe) {
      ...
      if (informe.puntos_mejora) {
        const loadedObs = informe.puntos_mejora.map((pm: any) => {
          const matchingAcc = informe.acciones_mejora?.find(
          ...
          return {
            ...
            id: pm.id,
            detalle: pm.detalle,
            accion: matchingAcc ? matchingAcc.descripcion : "",
            accion_id: matchingAcc ? matchingAcc.id : undefined,
    ...
    try {
      ...
      const payload = {
        ...
        puntos_mejora: observacionesCargadas.map((obs) => ({
          ...
          acciones: obs.accion
            ? [{ id: obs.accion_id, descripcion: obs.accion }]
            : [],
        })),
      };

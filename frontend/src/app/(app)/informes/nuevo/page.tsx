        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-6 shadow-2xs">
          ...
          <div className="space-y-2">
            ...
            <div className="border border-slate-200 rounded-xl bg-white">
              ...
              <div className="flex items-center gap-1.5 px-3 py-2 bg-slate-50 border-b border-slate-200 select-none rounded-t-xl">
                <button
                  type="button"
                      ...
                      <div className="absolute left-0 mt-1 w-64 rounded-xl bg-white border border-slate-200 shadow-lg py-2 z-20 animate-fadeIn text-xs">
                        ...
                        {DEFAULT_TEMPLATES.map((tmpl) => (
                          <button
                            ...
                            className="w-full text-left px-3 py-2 text-slate-700 hover:bg-slate-50 font-bold block truncate"
                            title={tmpl.content}
                          >
                            {tmpl.name}
                          </button>
                        ...
                        <div className="px-3 py-1 text-[9px] font-black text-slate-400 uppercase tracking-wider flex items-center justify-between">
                          ...
                          <button
                            ...
                            className="text-[9px] font-black text-blue-650 hover:underline lowercase tracking-normal cursor-pointer"
                          >
                            + guardar actual
                          </button>
                        </div>
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-3 pt-6 ">
            <button
              ...
              className="px-5 py-2.5 bg-white hover:bg-slate-50 border border-slate-200 text-slate-650 text-sm font-bold rounded-xl flex items-center justify-center transition-colors cursor-pointer"
            >
              Cancelar
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2.5 bg-brand-primary hover:bg-brand-primary/95 text-white text-sm font-bold rounded-xl flex items-center justify-center gap-2 shadow-md shadow-blue-900/10 hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl border border-slate-100 space-y-4 mx-4 text-center flex flex-col items-center">
            ...
            <div className="flex gap-2 w-full pt-2">
              ...
              <button
                ...
                className="flex-1 py-2.5 px-4 text-xs font-bold text-white bg-red-600 hover:bg-red-750 rounded-xl cursor-pointer transition-colors"
              >
                Eliminar
              </button>
            </div>

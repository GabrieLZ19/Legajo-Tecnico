...
export default function AdminPlantillasPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(null);
      if (editingPlantilla) {
        await editarPlantilla({ id: editingPlantilla.id, data: formData });
      } else {
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm font-medium text-slate-500 mt-1 text-balance">
            Gestioná los textos predefinidos para las declaraciones juradas y
          ...
          <div className="p-20 text-center">
            ...
            <p className="text-sm text-slate-500 mt-1">
              {searchTerm
                ...
                : "Comenzá creando tu primera plantilla."}
            </p>
          </div>
        )}
      </div>
            ...
            <div className="p-8 border-b border-slate-50 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm font-medium text-slate-500">
                  {editingPlantilla
                    ? "Actualizá el contenido base del informe."
                    : "Definí un nuevo texto predefinido."}
                </p>
              </div>
              <button
